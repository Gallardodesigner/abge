...
class FrontendAjaxController extends \BaseController {
	...
	public function getAdicionarescolaridade($id_asociado){
		...
		return View::make('ajax.frontend.adicionarescolaridade')->with($array);
	...
	public function getAtualizarescolaridade($id_escolaridade){
		...
		return View::make('ajax.frontend.atualizarescolaridade')->with($array);
	...
	public function getDeletarescolaridade($id_escolaridade){
		...
		return View::make('ajax.frontend.deletarescolaridade')->with($array);
