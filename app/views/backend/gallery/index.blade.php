...
<div class="maincontent">
            <div class="maincontentinner">
                ...
                <div class="widgetbox">
                    <div class="headtitle">
                        <div class="btn-group">
                            <a href="{{ $route }}/create" class="btn dropdown-toggle">{{ Lang::get('display.add_album')}}</a>
                        </div>
                        <h4 class="widgettitle">{{ Lang::get('display.all_album') }}</h4>
                    </div>
                                ...
                                @foreach($album as $album)
                                    <tr class="gradeX">
                                      <td class="aligncenter"><span class="center">
                                        ...
                                        <td>{{$album->leyenda}}</td>
                                        <td>{{$album->fecha}}</td>
                                        <td>{{ $album->imagen != 1 ? 'Inativo' : 'Ativo' }}</td>
                                        <td class="center">
                                            <a href="{{ $route }}/update/{{}}" class="btn btn-warning alertwarning" style="color:#FFF !important;"><i class="iconfa-edit" style="color:#FFF;margin-right:10px;"></i>{{Lang::get('display.edit')}}</a>
                                            <a data-id="{{}}" data-action="delete" class="btn confirmbutton btn-danger alertdanger" style="color:#FFF !important;"><i class="iconfa-trash" style="color:#FFF;margin-right:10px;"></i>{{Lang::get('display.delete')}}</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
