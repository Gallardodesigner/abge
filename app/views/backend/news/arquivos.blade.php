                    ...
                    <form class="stdform stdform2" method="post" enctype="multipart/form-data">
                        <p>
                            ...
                            <span class="formwrapper">
                                <select data-placeholder="Selecionar um Arquivo..." class="chzn-select" multiple="multiple" style="width:100%;" tabindex="4" name="arquivos[]">
                                    @foreach( $arquivos as $arquivo )
                                    	<option value="{{$arquivo->id_archivo_seccion}}" {{ $news->hasArquivo($arquivo) ? 'selected' : '' }}>{{ $arquivo->titulo_archivo}}</option>
                                    @endforeach
                                </select>
                            </span>
                        </p>
