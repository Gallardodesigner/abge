...
<div class="maincontent">
            <div class="maincontentinner">
                ...
                <h4 class="widgettitle">Adicionar Data</h4>
                <div class="widgetcontent">
                    <form class="stdform stdform2" method="post" enctype="multipart/form-data">
                        <p>
                            <label>Nome</label>
                            <span class="field"><input type="text" name="nome"></span></span>
                        </p>  
                        <p>
                            <label>Data de início</label>
                            <span class="field"><input id="start" type="input" name="data_inicio"></span></span>
                        </p>  
                        <p>
                            <label>Data de conclusão</label>
                            <span class="field"><input id="end" type="input" name="data_final"></span></span>
                        </p>   
                        <p>
                            <label>Preço (R$)</label>
                            <span class="field"><input type="text" name="preco"></span></span>
                        </p>  
                        <p>
                            <label>Pagseguro</label>
                            <span class="field"><textarea name="pagseguro"></textarea></span></span>
                        </p>  
                        <p class="pull-right">
