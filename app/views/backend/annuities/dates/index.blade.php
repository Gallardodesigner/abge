                    ...
                    <table id="dyntable" class="table table-bordered responsive">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="head0" width="60%">Nome do data</th>
                                <th class="head0" width="60%">Data de início</th>
                                <th class="head0" width="60%">Data da conclusão</th>
                                <th class="head0" width="60%">Preço</th>
                                <th class="head0" width="60%">Pagseguro</th>
                                ...
                                @foreach($dates as $date)
                                    <tr class="gradeX">
                                      <td class="aligncenter"><span class="center">
                                        ...
                                        <td class="center">
                                            <a href="{{ $route }}/update/{{$date->id}}" class="btn btn-warning alertwarning" style="color:#FFF !important;"><i class="iconfa-edit" style="color:#FFF;margin-right:10px;"></i>Editar</a>
                                            <a data-id="{{$date->id}}" data-action="delete" class="btn confirmbutton btn-danger alertdanger" style="color:#FFF !important;"><i class="iconfa-trash" style="color:#FFF;margin-right:10px;"></i>Eliminar</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
