...
<div class="maincontent">
            <div class="maincontentinner">
                ...
                <h4 class="widgettitle">Adicionar Pagamento</h4>
                <div class="widgetcontent">
                    <form class="stdform stdform2" method="post" enctype="multipart/form-data">
                        <p>
                            ...
                            <span class="field">
                                @if (isset($associates))
                                    ...
                                    <select class="chosen-select" name="id_asociado" style="width:500px;" required>
                                        <option value="0">-- SELECIONAR UM ASSOCIADO --</option>
                        ...
                        <p>
                            ...
                            <span class="field"><input type="number" name="pagamento" required></span></span>
                        </p>  
                        <p>
                            <label>Data de Pagamento</label>
                            <span class="field"><input id="end" type="input" name="data_pagamento" required></span></span>
                        </p>   
                        <p>
                            <label>Status de pagamento</label>
                            <span class="field">
                            	<span><input type="radio" name="status" style="opacity: 0;" value="true"></span> Pagado &nbsp; &nbsp;
                            	<span class="checked"><input type="radio" name="status" checked="checked" style="opacity: 0;" value="false"></span> Não Pagado &nbsp; &nbsp;
                            </span>
                        </p>  
                        <p class="pull-right">
