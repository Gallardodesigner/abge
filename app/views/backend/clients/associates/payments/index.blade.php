                ...
                <div class="widgetbox">
                    <div class="headtitle">
                        <div class="btn-group">
                            ...
                            @if(!$associate->hasPaymentByAnnuity( ORGAnnuities::getLastAnnuity() ))
                            	<a href="{{ $route }}/create" class="btn dropdown-toggle" style="padding-left: 20px;">Adicionar Pagamento</a>
                            @endif
                        </div>
                        <h4 class="widgettitle">Todos os Pagamentos do associado {{ $associate->nombre_completo }}</h4>
                    </div>
                    <table id="dyntable" class="table table-bordered responsive">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="head0" width="60%">Anuidad</th>
                                ...
                                @foreach($payments as $payment)
                                    <tr class="gradeX">
                                      <td class="aligncenter"><span class="center">
                                        ...
                                        <td>{{ $payment->category->annuity->ano }}</td>
