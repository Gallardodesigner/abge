                        ...
                        <form id="associate" class="stdform " method="POST" action="" enctype="multipart/form-data">
                            <div id="wizard" class="wizard">
                                ...
                                <div id="wiz1step1" class="formwiz">
                                    ...
                                    <p>
                                        <label>CPF</label>
                                        <span class="field"><input type="text" name="cpf" id="cpf" class="input-xxlarge" /></span>
                                    </p>
                                    <p>
                                ...
                                <div id="wiz1step2" class="formwiz">
                                    ...
                                    <p>
                                        <label>DDI Cel - Celular</label>
                                        <span class="field"><input type="text" name="ddd_cel_res" id="ddd_cel_res" class="input-small" /><input type="text" name="ddi_cel_res" id="ddi_cel_res" class="input-small" /><input type="text" name="cel_res" id="cel_res" class="input-xlarge" /></span>
                                    </p>                                                          
                                </div>
