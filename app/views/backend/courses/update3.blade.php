                            ...
                            <div id="wizard" class="wizard">
                                ...
                                <div id="wiz1step3" class="formwiz">
                                    <h4 class="widgettitle">Step 3: Content</h4>
                                        ...
                                        <p>
                                            <label>Content</label>
                                            <span class="field"><textarea cols="50" rows="10" name="content" class="span6"> {{ $course->content }} </textarea></span>
                                        </p>
                                ...
                                <div id="wiz1step4" class="formwiz">
                                    <h4 class="widgettitle">Step 4: Program Content</h4>
                                        ...
                                        <p>
                                            <label>Content</label>
                                            <span class="field"><textarea cols="50" rows="10" name="program" class="span6"> {{ $course->program }} </textarea></span>
                                        </p>
                                            ...
                                            <span class="field">
                                                        ...
                                                        @if(isset($teachers))
                                                            ...
                                                            @foreach ($teachers as $teacher)
																<?php $band = false; ?>
																@foreach($course->teachers as $asoc)
																	@if($teacher->id == $asoc->id)
																		<?php $band = true; ?>
																	@endif	
																@endforeach
																@if($band)
