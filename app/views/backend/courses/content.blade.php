...
<div class="maincontent">
            <div class="maincontentinner">
                ...
                <div class="widget">
                    ...
                    <h4 class="widgettitle">{{ Lang::get('display.add_content') }}</h4>
                                ...
                                <ul class="hormenu">
                                    ...
                                    <li>
                                        <a href="#wiz1step4">
                                            ...
                                            <span class="label">{{ Lang::get('display.payment')}}</span>
                                        </a>
                                    </li>
