                ...
                <div class="widgetcontent">
                    <form class="stdform stdform2" method="post" enctype="multipart/form-data">
                            <p>
                                ...
                                <span class="field"><input type="text" name="titulo_video" id="title" class="input-xxlarge" value="{{ $video->titulo_video }}"></span>
                            </p>  
                            <p>
                                <label>Embed Video Youtube</label>
                                <span class="field"><input type="text" name="url_video" class="input-xxlarge" value="{{ $video->url_video }}"></span></span>
                            </p>
                            <p class="pull-right">
