...
<div class="maincontent">
            <div class="maincontentinner">
                ...
                <h4 class="widgettitle">Adicionar Banner</h4>
                    ...
                    <form class="stdform stdform2" method="post" enctype="multipart/form-data">
                            ...
                            <p>
                             ...
                             <p>
                                <label>Tipo</label>
                                <span class="field">
                                    Publicações <input type="checkbox" name="type[]" value="publicaciones"/>
                                    Socios - Patrocinadores <input type="checkbox" name="type[]" value="socios"/>
                                    Eventos- Apoio ABGE <input type="checkbox" name="type[]" value="eventos"/>
