<form id="adicionarescolaridade">
    <div id="wiz1step5" class="formwiz">
        ...
        <p>
            ...
            <span>
                <select class="form-control" name="tipo_graduacion" id="asociados_datos_academicos_tipo_graduacion" required>
        ...
        <p>
            ...
            <span class="field"><input type="text" name="institucion" id="institucion" class="form-control" required/></span>
        </p>
        <p>
            <label class="control-label">Faculdade:</label>
            <span class="field"><input type="text" name="facultad" id="facultad" class="form-control" required/></span>
        </p>
        <p>
        ...
        <p>
            ...
            <span class="field"><input type="text" name="ano_inicio" id="ano_inicio" class="form-control" required/></span>
        </p>
        <p>
            <label class="control-label">Ano de finalização</label>
            <span class="field"><input type="text" name="ano_finalizacion" id="ano_finalizacion" class="form-control" required/></span>
        </p>  
        <p>
            
            <span class="right"><input type="submit" class="btn btn-primary" value="Adicionar"/></span>
        </p>                                                  
    </div>
</form>
