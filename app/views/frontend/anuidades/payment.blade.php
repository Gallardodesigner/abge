...
<div class="left_column">
	<div class="courses-list">
		<h3>faça o seu pagamento </h3>

		<p>{{ $date->nome }} {{ date('d/m',strtotime($date->data_inicio))}} Até {{ date('d/m',strtotime($date->data_final))}}</p>
		<p>Preço: R$ {{ $date->preco }}</p>
		<span>{{ $date->pagseguro }}</span>
	</div>
</div>
