	...
	<div class="row"> 
		...
		<div class="col-md-8">
			<div style="padding:10px;">
				...
				<h4 align="center"><strong>Dúvidas frequentes</strong></h4>

			    <p>&nbsp;</p>
 
				<h4>1- Como alterar dados no meu cadastro?</h4>
				<p>Clique na aba Meu Cadastro localizada no Menu Principal. Em seguida clique no campo que deseja alterar, para finalizar e salvar as alterações clique no botão Salvar na parte inferior da tela.</p>
				<h4>2- Como gerar boleto para pagamento da anuidade?</h4>
				<p>Para gerar seu boleto clique na aba Anuidades localizada no Menu. Depois clique no código de barras na opção “2ª via de boleto” da anuidade do ano vigente.</p>
				<h4>3- Como imprimo meu boleto?</h4>
				<p>Após seguir os passos para gerar o boleto (item 1), clique no botão Imprimir que aparecerá no canto esquerdo na parte inferior da tela. Caso não o visualize utilize a barra de rolagem lateral para descer a página e localizá-lo. Ou pressione as teclas Ctrl + p.</p>
				<h4>4- Como parcelar a anuidade?</h4>
				<p>Clique na aba Anuidades localizada no Menu. Em seguida clique no ícone do sistema Pagseguro em “Formas de Pagamento”, você será redirecionado para o ambiente do sistema e nele poderá efetuar o parcelamento da sua anuidade no cartão de crédito.</p>
				<h4>5 – Como parcelar a anuidade no boleto bancário?</h4>
				<p>Para parcelar sua anuidade em até três vezes no boleto bancário entre em contato com a Secretaria Executiva da ABGE pelo e-mail: atendimento@abge.org.br</p>
				<h4>6- Como sair do sistema?</h4>
				<p>Clique no botão Sair localizado na barra de Menu.</p>
