...
@section("maincontent")
    ...
    <form class="updateform" method="post">
		...
		<div class="control-box">
			<label>Bairro: </label>
			<input type="text" name="bairro" value="{{ $participant->bairro }}"/>
		</div>
		<div class="control-box">
			<label>Cidade: </label>
			...
			<select name="estado">
				...
				@foreach($estados as $state)
					@if($participant->estado == $state->name_estado)
						<option value="{{$state->name_estado}}" selected>{{$state->name_estado}}</option>
					@else
		...
		<div class="control-box">
			<label>Endereço: </label>
			<input type="text" name="endereco_empresa" value="{{ $participant->endereco_empresa }}"/>
		</div>
		<div class="control-box">
			<label>N°: </label>
			<input type="text" name="numero_empresa" value="{{ $participant->numero_empresa }}"/>
		</div>
		<div class="control-box">
			<label>Complemento: </label>
			<input type="text" name="complemento_empresa" value="{{ $participant->complemento_empresa }}"/>
		</div>
		<div class="control-box">
			<label>Bairro: </label>
			<input type="text" name="bairro_empresa" value="{{ $participant->bairro_empresa }}"/>
		</div>
		<div class="control-box">
			<label>Cidade: </label>
			<input type="text" name="cidade_empresa" value="{{ $participant->cidade_empresa }}"/>
		</div>
		<div class="control-box">
			<label>Estado: </label>
		...
		<div class="control-box">
			<label>CEP: </label>
			<input type="text" name="cep_empresa" value="{{ $participant->cep_empresa }}"/>
		</div>
		<!-- <br>
